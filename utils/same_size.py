...
def process_dataset(input_folder, output_folder):
    ...
    class_dirs = [d for d in os.listdir(input_folder) if os.path.isdir(os.path.join(input_folder, d))]

    if not class_dirs:
        print(f"No class directories found in {input_folder}. Exiting.")
        return
...
if __name__ == '__main__':
    ...
    INPUT_DATASET_FOLDER = 'D:\\amir_es\\car_accessories_dataset\\new'
    # Set the name for the new, cleaned dataset folder
    OUTPUT_DATASET_FOLDER = 'D:\\amir_es\\car_accessories_dataset\\new_same_sized'
    # -------------------
