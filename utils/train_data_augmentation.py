...
def create_augmentation_pipeline():
    return A.Compose([
        ...
        A.ShiftScaleRotate(
            ...
            scale_limit=0.07,       # Reduced from 0.1
            rotate_limit=20,       # Reduced from 15
        ...
        A.Perspective(
            scale=(0.015, 0.04),    # Reduced from (0.02, 0.06)
        ...
        for class_name in tqdm(class_dirs, desc="Processing classes"):
            ...
            for img_path in image_paths:
                try:
                    ...
                    new_filename = f"{class_name}_{base_filename}_original.jpg"
...
if __name__ == '__main__':
    ...
    INPUT_IMAGE_DIRECTORY = "D:\\amir_es\\car_accessories_dataset\\train_new_2048"
    OUTPUT_IMAGE_DIRECTORY = "D:\\amir_es\\car_accessories_dataset\\train_noisy_aug"
