...
def create_augmentation_pipeline():
    return A.Compose([
        ...
        A.ShiftScaleRotate(
            ...
            rotate_limit=25,       # Reduced from 15
        ...
        A.OneOf([
            A.GaussianBlur(blur_limit=(1, 7), p=0.5), # Max blur limit reduced from 7
            A.MotionBlur(blur_limit=(1, 7), p=0.5), # Max blur limit reduced from 7
...
if __name__ == '__main__':
    ...
    INPUT_IMAGE_DIRECTORY = "D:\\amir_es\\car_accessories_dataset\\train_new_512"
    OUTPUT_IMAGE_DIRECTORY = "D:\\amir_es\\car_accessories_dataset\\train_aug"
    IMAGES_PER_ORIGINAL = 24 # Generate 25 new images for each original
